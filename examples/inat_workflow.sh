...
bioamla ast-finetune --training-dir "./frogs_out" --train-dataset ./frogs_dataset --num-train-epochs 1
...
bioamla ast-batch-inference "./frogs" --model-path "scp-frogs/best_model"
