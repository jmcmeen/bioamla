"""Metadata CSV helpers for catalog downloads.

Direct pathlib/csv implementations of the small set of metadata utilities the
iNaturalist downloader needs. Copied (and de-layered) from the legacy
legacy core metadata module so the catalogs package owns its own I/O.
"""
import csv
import logging
import warnings
