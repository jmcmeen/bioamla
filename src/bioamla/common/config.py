...
TOML-based configuration file support for bioamla.
...
This module performs direct file I/O via :mod:`pathlib` / :func:`open` and
raises :class:`~bioamla.exceptions.ConfigError` on TOML parse failure.
"""
